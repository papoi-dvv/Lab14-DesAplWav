...
export default function AboutPage() {
  const skills = [
    { name: 'JavaScript', logo: '/jscript.svg' },
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {skills.map((skill) => (
              <div
                key={skill.name}
                className="flex min-h-32 flex-col items-center justify-center gap-3 rounded-lg bg-white p-4 text-center shadow-md transition-shadow hover:shadow-lg"
              >
